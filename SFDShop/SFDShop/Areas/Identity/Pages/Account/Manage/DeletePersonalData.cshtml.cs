...
namespace SFDShop.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (RequirePassword)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Złe hasło.");
                    return Page();
                }
            }
            ...
            _logger.LogInformation("Użytkownik o identyfikatorze  '{UserId}' sam się usunął.", userId);
